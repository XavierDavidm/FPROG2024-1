...
R=Percetual(T2,N)
print('o total de repetiçoes do valor 1 é',T2,'ou seja',R,'%','de',N)
R=Percetual(T3,N)
print('o total de repetiçoes do valor 1 é',T3,'ou seja',R,'%','de',N)
R=Percetual(T4,N)
print('o total de repetiçoes do valor 1 é',T4,'ou seja',R,'%','de',N)
R=Percetual(T5,N)
print('o total de repetiçoes do valor 1 é',T5,'ou seja',R,'%','de',N)
R=Percetual(T6,N)
print('o total de repetiçoes do valor 1 é',T6,'ou seja',R,'%','de',N)